...
const I18N = {
  ar: {
    ...
    confirm_add_calendar: "إضافة إلى تقويم Google",
    confirm_add_calendar_ics: "تنزيل الحدث (Outlook / Apple)",
    ...
    admin_period_month: "حجوزات الشهر",
    admin_chart_period: "توزيع الحجوزات",
    admin_chart_company: "الحجوزات حسب الشركة (هذا الشهر)",
    admin_chart_quota: "استهلاك الساعات المجانية",
    admin_no_company: "بدون شركة",
    admin_no_data: "لا توجد بيانات",
    admin_quota_used: "مستخدم",
    admin_quota_remaining: "متبقٍ",
  ...
  en: {
    ...
    confirm_add_calendar: "Add to Google Calendar",
    confirm_add_calendar_ics: "Download event (Outlook / Apple)",
    ...
    admin_period_month: "Bookings this month",
    admin_chart_period: "Booking distribution",
    admin_chart_company: "Bookings by company (this month)",
    admin_chart_quota: "Free-hours usage",
    admin_no_company: "No company",
    admin_no_data: "No data",
    admin_quota_used: "Used",
